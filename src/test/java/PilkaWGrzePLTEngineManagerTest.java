...
public class PilkaWGrzePLTEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(PilkaWGrzePLTEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/PilkaWGrzePLTIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/PilkaWGrzePLTIW/InitOutcome.xml").getDocumentElement();
